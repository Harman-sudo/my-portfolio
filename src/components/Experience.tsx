...
const accentMap: Record<string, { dot: string; border: string; bg: string; text: string; badge: string }> = {
  blue:   { dot: 'bg-blue-600',   border: 'border-blue-500/25',   bg: 'bg-blue-500/5',   text: 'text-blue-600 dark:text-blue-400',   badge: 'bg-blue-500/10 text-blue-700 dark:text-blue-300 border-blue-500/30' },
  indigo: { dot: 'bg-indigo-500', border: 'border-indigo-500/25', bg: 'bg-indigo-500/5', text: 'text-indigo-600 dark:text-indigo-400', badge: 'bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border-indigo-500/30' },
}
        ...
        <div className="relative pl-8 timeline-line space-y-8">
          {EXPERIENCES.map((exp, i) => {
            ...
            return (
              ...
              >
                {/* Timeline dot */}
                <div className={`absolute -left-[37px] top-5 w-3 h-3 rounded-full ${a.dot} ring-2 ring-[var(--bg-alt)]`} />
